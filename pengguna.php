                                            ...
                                            <table class="table table-striped  mb-0">
                                                ...
                                                ?>
                                                    <tr align="center">
                                                        ...
                                                        <td>
                                                            <a href="pengguna_edit.php?id=<?= $row['id_pengguna'] ?>"  class="btn btn-sm btn-outline-dark waves-effect waves-light">Edit</a>
                                                            <a href="pengguna_hapus.php?id=<?= $row['id_pengguna'] ?>"  class="btn btn-sm btn-outline-danger waves-effect waves-light">Delete</a>
                                                        </td>
                                                    </tr>
                                                    <?php $i++; ?>
                                                    <?php endforeach; ?>
