...
if( isset($_POST["tambah"]) ) {
        ...
        echo"<script>
                alert('Kategoti berhasil ditambahkan!');
                                        ...
                                        <form action="" method="post">
                                            ...
                                            <label for="formrow-firstname-input" class="form-label">Pilih Pengguna</label>
                                                <select id="formrow-inputState" name="id_pengguna" class="form-select">
                                                    <option disable selected>SILAHKAN PILIH PENGGUNA</option>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="formrow-firstname-input" placeholder="Masukkan Kode" name="kode_kategori">
                                            </div>

                                            <div class="mb-3">
                                                <label for="formrow-firstname-input" class="form-label">Kategori</label>
                                                <input type="text" class="form-control" id="formrow-firstname-input" placeholder="Masukkan Kategori" name="kategori">
                                            </div>

                                            <div class="mb-3">
                                                <label for="formrow-firstname-input" class="form-label">Keterangan</label>
                                                <input type="text" class="form-control" id="formrow-firstname-input" placeholder="Keterangan" name="keterangan">
                                            </div>
